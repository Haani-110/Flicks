...
export class AppErrorBoundary extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div className="mx-auto flex min-h-[60vh] w-full max-w-5xl items-center justify-center px-4 py-12">
        <div className="card w-full max-w-lg p-6 text-center sm:p-8">
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-[#e05555]/10">
          ...
          <div className="mt-5 flex justify-center gap-2">
            <button type="button" onClick={() => window.location.reload()} className="btn btn-primary">Reload</button>
